...
./_load.sh $process_date 	segment_android_view_category_car.csv 469608434
./_load.sh $process_date 	segment_ios_view_category_car.csv 469738885
./_load.sh $process_date 	segment_android_search_keywords_car.csv 469738810
./_load.sh $process_date 	segment_ios_search_keywords_car.csv 469738957
./_load.sh $process_date 	segment_android_view_item_car.csv 472620027
./_load.sh $process_date 	segment_ios_view_item_car.csv 469608599
